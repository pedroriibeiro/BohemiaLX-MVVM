...
protocol CreateReserve2ScreenProtocol: AnyObject {
    func didEnterData(data: Reservation)
}

class CreateReserve2Screen: UIView {
    
    var selecDate: String?
    var texto: String?
    var numero: Int?
    
    private weak var delegate: CreateReserve2ScreenProtocol?
    public func delegate(delegate: CreateReserve2ScreenProtocol?) {
